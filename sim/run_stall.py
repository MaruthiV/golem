...
def main():
    srcs = ["requant.sv", "divu.sv", "matmul_row.sv", "rmsnorm.sv", "softmax_row.sv",
            ...
            "sdram_chip.sv", LIB / "wstream.sv", "sim_mem.sv", "stall_probe.sv"]
    runner = get_runner("icarus")
    runner.build(sources=[s if isinstance(s, Path) else RTL / s for s in srcs], hdl_toplevel="golem_board_probe",
